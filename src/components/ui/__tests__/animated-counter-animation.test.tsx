...
describe("AnimatedCounter - Animation Behavior", () => {
  ...
  describe("Animation Behavior", () => {
    ...
    it("handles value changes during animation", () => {
      ...
      rerender(<AnimatedCounter to={200} duration={1000} autoStart={true} />);
    ...
    it("respects custom duration", () => {
      render(<AnimatedCounter to={100} duration={2000} autoStart={true} />);
    ...
    it("handles zero duration", () => {
      render(<AnimatedCounter to={100} duration={0} autoStart={true} />);
    ...
    it("prevents multiple simultaneous animations", () => {
      ...
      rerender(<AnimatedCounter to={200} duration={1000} autoStart={true} />);
      rerender(<AnimatedCounter to={300} duration={1000} autoStart={true} />);
    ...
    it("animates backwards when new value is smaller", () => {
      ...
      render(<AnimatedCounter to={50} duration={1000} autoStart={true} />);
    ...
    it("handles very short durations", () => {
      render(<AnimatedCounter to={100} duration={1} autoStart={true} />);
    ...
    it("handles very long durations", () => {
      render(<AnimatedCounter to={100} duration={10000} autoStart={true} />);
