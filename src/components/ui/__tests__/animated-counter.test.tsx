...
describe("AnimatedCounter Component", () => {
  ...
  describe("Basic Rendering", () => {
    ...
    it("applies default classes", () => {
      render(<AnimatedCounter to={100} data-testid="counter" />);
  ...
  describe("Animation Behavior", () => {
    it("starts animation when autoStart is true", () => {
      render(<AnimatedCounter to={100} autoStart duration={1000} />);
    ...
    it("does not start animation when autoStart is false", () => {
      render(
        <AnimatedCounter to={100} autoStart={false} triggerOnVisible={false} />,
      );
    ...
    it("applies animate-pulse class during animation", async () => {
      render(<AnimatedCounter to={100} autoStart data-testid="counter" />);
    ...
    it("handles animation with custom duration", () => {
      render(<AnimatedCounter to={100} autoStart duration={500} />);
  ...
  describe("Trigger Options", () => {
    it("handles triggerOnVisible prop", () => {
      render(
        <AnimatedCounter to={100} triggerOnVisible data-testid="counter" />,
      );
  ...
  describe("Delay Functionality", () => {
    ...
    it("cleans up delay timer on unmount", () => {
      ...
      const { unmount } = render(
        <AnimatedCounter to={100} autoStart delay={1000} />,
      );
  ...
  describe("Edge Cases", () => {
    ...
    it("handles negative values", () => {
      render(
        <AnimatedCounter to={-50} from={0} autoStart data-testid="counter" />,
      );
    ...
    it("handles same from and to values", () => {
      render(
        <AnimatedCounter to={100} from={100} autoStart data-testid="counter" />,
      );
  ...
  describe("Animation State Management", () => {
    it("prevents multiple simultaneous animations", () => {
      ...
      rerender(<AnimatedCounter to={200} autoStart />);
    ...
    it("resets animation when key props change", () => {
      const { rerender } = render(
        <AnimatedCounter to={100} autoStart data-testid="counter" />,
      );

      // Change the target value
      rerender(<AnimatedCounter to={200} autoStart data-testid="counter" />);
    ...
    it("handles component unmount during animation", () => {
      const { unmount } = render(<AnimatedCounter to={100} autoStart />);
  ...
  describe("Ref Handling", () => {
    ...
    it("handles function ref correctly", () => {
      ...
      render(<AnimatedCounter to={100} ref={refCallback} />);
    ...
    it("combines refs with intersection observer", () => {
      ...
      render(<AnimatedCounter to={100} ref={ref} triggerOnVisible />);
  ...
  describe("Performance", () => {
    ...
    it("handles rapid prop changes efficiently", () => {
      ...
      for (let i = 0; i < TEST_COUNT_CONSTANTS.LARGE; i++) {
        rerender(<AnimatedCounter to={100 + i} autoStart />);
      }
  ...
  describe("极端边缘情况", () => {
    ...
    it("should handle NaN values gracefully", () => {
      render(
        <AnimatedCounter to={NaN} from={0} autoStart data-testid="counter" />,
      );
