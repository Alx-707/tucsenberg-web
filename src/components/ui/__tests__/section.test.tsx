...
describe("Section", () => {
  ...
  it("accepts className for cv-* and other overrides", () => {
    render(
      <Section className="cv-600 custom-class" data-testid="section">
        Content
      </Section>,
    );
    const section = screen.getByTestId("section");
  ...
  it("supports anchor links via id prop", () => {
    render(
      <Section id="features" data-testid="section">
        Content
      </Section>,
    );
    const section = screen.getByTestId("section");
  ...
  it("passes through additional props", () => {
    render(
      <Section aria-labelledby="section-heading" data-testid="section">
