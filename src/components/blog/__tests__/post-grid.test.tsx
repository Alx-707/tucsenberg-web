...
describe("PostGrid", () => {
  ...
  describe("grid column classes", () => {
    ...
    it("applies sm=2 column class", () => {
      ...
      const { container } = render(
        <PostGrid posts={posts} columns={{ sm: 2 }} />,
      );
    ...
    it("applies md=1 column class", () => {
      const posts = createMockPosts(2);
      const { container } = render(
        <PostGrid posts={posts} columns={{ md: 1 }} />,
      );
    ...
    it("applies md=3 column class", () => {
      const posts = createMockPosts(2);
      const { container } = render(
        <PostGrid posts={posts} columns={{ md: 3 }} />,
      );
    ...
    it("applies lg=4 column class", () => {
      const posts = createMockPosts(2);
      const { container } = render(
        <PostGrid posts={posts} columns={{ lg: 4 }} />,
      );
    ...
    it("applies lg=2 column class", () => {
      const posts = createMockPosts(2);
      const { container } = render(
        <PostGrid posts={posts} columns={{ lg: 2 }} />,
      );
    ...
    it("applies lg=1 column class", () => {
      const posts = createMockPosts(2);
      const { container } = render(
        <PostGrid posts={posts} columns={{ lg: 1 }} />,
      );
  ...
  describe("gap classes", () => {
    ...
    it("applies gap-4 when gap=4", () => {
      const posts = createMockPosts(2);
      const { container } = render(<PostGrid posts={posts} gap={4} />);
    ...
    it("applies gap-8 when gap=8", () => {
      const posts = createMockPosts(2);
      const { container } = render(<PostGrid posts={posts} gap={8} />);
  ...
  describe("custom className", () => {
    it("applies custom className to grid", () => {
      const posts = createMockPosts(2);
      const { container } = render(
        <PostGrid posts={posts} className="custom-grid-class" />,
      );
    ...
    it("preserves default classes with custom className", () => {
      const posts = createMockPosts(2);
      const { container } = render(
        <PostGrid posts={posts} className="my-custom" />,
      );
  ...
  describe("props passed to PostCard", () => {
    ...
    it("passes custom linkPrefix to cards", () => {
      const posts = createMockPosts(1);
      render(<PostGrid posts={posts} linkPrefix="/zh/blog" />);
