...
describe("InteractiveShowcase", () => {
  ...
  describe("点赞交互", () => {
    it("应该支持点赞功能", () => {
      ...
      render(<InteractiveShowcase {...mockProps} handleLike={handleLike} />);
    ...
    it("应该显示点赞数量", () => {
      render(<InteractiveShowcase {...mockProps} likeCount={100} />);
    ...
    it("应该根据isLiked状态显示不同样式", () => {
      const { rerender } = render(
        <InteractiveShowcase {...mockProps} isLiked={false} />,
      );
      ...
      rerender(<InteractiveShowcase {...mockProps} isLiked={true} />);
  ...
  describe("边界条件", () => {
    ...
    it("应该处理负数的点赞数量", () => {
      render(<InteractiveShowcase {...mockProps} likeCount={-5} />);

      expect(screen.getByText("-5")).toBeInTheDocument();
    });

    it("应该处理极大的点赞数量", () => {
      render(<InteractiveShowcase {...mockProps} likeCount={999999} />);
