...
describe("Theme Menu Item - Rendering Tests", () => {
  ...
  describe("基本渲染", () => {
    ...
    it("renders with different icons correctly", () => {
      const { rerender } = render(
        <ThemeMenuItem {...defaultProps} icon={Moon} />,
      );
      expect(screen.getByRole("menuitem")).toBeInTheDocument();

      rerender(<ThemeMenuItem {...defaultProps} icon={Sun} />);
      expect(screen.getByRole("menuitem")).toBeInTheDocument();
    });

    it("renders with custom label", () => {
      render(<ThemeMenuItem {...defaultProps} label="Custom Theme" />);

      expect(screen.getByText("Custom Theme")).toBeInTheDocument();
    });

    it("renders with custom aria-label", () => {
      render(<ThemeMenuItem {...defaultProps} ariaLabel="Custom aria label" />);
  ...
  describe("选择状态", () => {
    it("shows selected indicator when theme matches currentTheme", () => {
      render(
        <ThemeMenuItem {...defaultProps} theme="light" currentTheme="light" />,
      );
    ...
    it("does not show selected indicator when theme does not match currentTheme", () => {
      render(
        <ThemeMenuItem {...defaultProps} theme="light" currentTheme="dark" />,
      );
    ...
    it("applies selected styling when theme matches currentTheme", () => {
      render(
        <ThemeMenuItem {...defaultProps} theme="dark" currentTheme="dark" />,
      );
  ...
  describe("图标显示", () => {
    it("renders Sun icon for light theme", () => {
      render(<ThemeMenuItem {...defaultProps} theme="light" icon={Sun} />);
    ...
    it("renders Moon icon for dark theme", () => {
      render(<ThemeMenuItem {...defaultProps} theme="dark" icon={Moon} />);
  ...
  describe("边界情况", () => {
    ...
    it("handles empty label gracefully", () => {
      render(<ThemeMenuItem {...defaultProps} label="" />);
    ...
    it("handles missing aria-label gracefully", () => {
      render(
        <ThemeMenuItem {...defaultProps} ariaLabel="Default aria label" />,
      );
