...
vi.mock("lucide-react", () => ({
  ...
  Factory: (props: React.SVGProps<SVGSVGElement>) => (
    <svg data-testid="factory-icon" {...props} />
  ),
...
describe("ProductCard", () => {
  describe("basic rendering", () => {
    ...
    it("renders link with correct href", () => {
      ...
      render(<ProductCard product={product} linkPrefix="/en/products" />);
  ...
  describe("cover image", () => {
    ...
    it("hides cover image when showCoverImage is false", () => {
      const product = createMockProduct();
      render(<ProductCard product={product} showCoverImage={false} />);
  ...
  describe("featured badge", () => {
    ...
    it("uses custom featured label", () => {
      const product = createMockProduct({ featured: true });
      render(<ProductCard product={product} labels={{ featured: "精选" }} />);
  ...
  describe("trade info", () => {
    ...
    it("hides trade info when showTradeInfo is false", () => {
      ...
      render(<ProductCard product={product} showTradeInfo={false} />);
  ...
  describe("custom styling", () => {
    it("applies custom className to card", () => {
      const product = createMockProduct();
      render(<ProductCard product={product} className="custom-class" />);
