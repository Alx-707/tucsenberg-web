...
describe("ProductGallery", () => {
  ...
  describe("basic rendering", () => {
    it("renders main image with first image", () => {
      render(<ProductGallery images={sampleImages} title="Test Product" />);
    ...
    it("renders container with space-y-4 class", () => {
      const { container } = render(
        <ProductGallery images={sampleImages} title="Test Product" />,
      );
    ...
    it("returns null for empty images array", () => {
      const { container } = render(
        <ProductGallery images={[]} title="Test Product" />,
      );
  ...
  describe("alt text", () => {
    it("generates correct alt text for main image", () => {
      render(<ProductGallery images={sampleImages} title="Premium Widget" />);
  ...
  describe("edge cases", () => {
    ...
    it("handles many images", () => {
      ...
      render(<ProductGallery images={manyImages} title="Many Images" />);
    ...
    it("handles images with query parameters", () => {
      ...
      render(<ProductGallery images={imagesWithParams} title="Query Params" />);
    ...
    it("navigates through all images sequentially", () => {
      render(<ProductGallery images={sampleImages} title="Test" />);
