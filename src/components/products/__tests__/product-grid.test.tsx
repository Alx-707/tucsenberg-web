...
describe("ProductGrid", () => {
  ...
  describe("grid columns", () => {
    ...
    it("applies sm=2 column class", () => {
      ...
      const { container } = render(<ProductGrid products={products} sm={2} />);
    ...
    it("applies md=3 column class", () => {
      ...
      const { container } = render(<ProductGrid products={products} md={3} />);
    ...
    it("applies lg=4 column class", () => {
      ...
      const { container } = render(<ProductGrid products={products} lg={4} />);
  ...
  describe("grid gap", () => {
    ...
    it("applies gap-4", () => {
      ...
      const { container } = render(<ProductGrid products={products} gap={4} />);
    ...
    it("applies gap-8", () => {
      ...
      const { container } = render(<ProductGrid products={products} gap={8} />);
  ...
  describe("props forwarding", () => {
    it("passes linkPrefix to ProductCard", () => {
      ...
      render(<ProductGrid products={products} linkPrefix="/zh/products" />);
    ...
    it("passes showCoverImage to ProductCard", () => {
      ...
      render(<ProductGrid products={products} showCoverImage={false} />);
    ...
    it("passes showCategory to ProductCard", () => {
      ...
      render(<ProductGrid products={products} showCategory={false} />);
    ...
    it("passes showTradeInfo to ProductCard", () => {
      ...
      render(<ProductGrid products={products} showTradeInfo={false} />);
    ...
    it("passes labels to ProductCard when provided", () => {
      ...
      render(<ProductGrid products={products} labels={labels} />);
  ...
  describe("custom styling", () => {
    it("applies custom className to grid", () => {
      ...
      const { container } = render(
        <ProductGrid products={products} className="custom-grid-class" />,
      );
