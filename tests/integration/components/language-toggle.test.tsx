  ...
  Link: ({
    ...
    const hrefString =
      typeof href === "string"
        ? href
        : href.pathname
            .replace("[category]", href.params?.category || "")
            .replace("[slug]", href.params?.slug || "");
    return (
      <a
...
describe("LanguageToggle Integration Tests", () => {
  ...
  describe("Navigation Integration", () => {
    ...
    it("should preserve current pathname during language switch", async () => {
      // Note: /products/glass is now interpreted as /products/[category] with category=glass
      const testPaths = ["/about", "/contact", "/products/glass"];
    ...
    it("should handle complex pathnames with parameters", async () => {
      // Note: /products/commercial/shopfront-system matches /products/[category]/[slug]
      mockUsePathname.mockReturnValue("/products/commercial/shopfront-system");
      ...
      links.forEach((link) => {
        expect(link).toHaveAttribute(
          "href",
          "/products/commercial/shopfront-system",
        );
      });
    });
  });
